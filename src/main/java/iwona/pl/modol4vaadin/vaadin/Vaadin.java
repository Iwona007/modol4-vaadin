package iwona.pl.modol4vaadin.vaadin;
...
// add car
        ...
        ComboBox<Color> colorComboBox = new ComboBox<>("Color type", Color.values());
...
//        footerRow.getCell(brandColumn).setComponent(addButton);
//        footerRow.getCell(modelColumn).setComponent(addButton);
//        footerRow.getCell(colorColumn).setComponent(addButton);
